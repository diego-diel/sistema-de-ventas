...
<head>
    ...
    <style>
        .login-page{
            ...
            background-image:url("https://images.unsplash.com/photo-1597423498219-04418210827d?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D") !important
            ;
        }
    </style>
...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="../public/templeates/AdminLTE-3.2.0/index2.html" class="h1"><b>Sistema de Ventas</b> Ferreteria</a>
        </div>
        <div class="card-body">
